...
class projetModel(models.Model):
    ...
    photoUrl = models.ImageField(
        upload_to="photo_folder/", blank=True, null=True)
    logoUrl = models.ImageField(
        upload_to="logo_folder/", blank=True, null=True)
    sponsorLogoUrl = models.ImageField(
        upload_to="logo_sponsor/", blank=True, null=True)
